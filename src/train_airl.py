...
def update_params_airl(batch, i_iter):
    ...
    weathers = torch.from_numpy(np.stack(batch.speed)).long().to(device)
...
if __name__ == '__main__':
    ...
    max_iter_num = 800  # maximal number of main iterations {100size: 1000, 1000size: 2000, 10000size: 3000}
